...
<h1 style="font-size: 1.8rem;">Form Tambah Data Karyawan</h1>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="nama_lengkap" name="nama_lengkap" class="form-control" placeholder="Masukkan nama lengkap Anda" value="{{ old('nama_lengkap') }}" required>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="nomor_telepon" name="nomor_telepon" class="form-control" placeholder="08xxxxxxxxxx" value="{{ old('nomor_telepon') }}" required>
                </div>
                 <div class="form-group mb-3">
                    <label for="nip">NIP *</label>
                    <input type="text" id="nip" name="nip" class="form-control" placeholder="Nomor Induk Pegawai" value="{{ old('nip') }}" required>
                </div>
                <div class="form-group mb-3">
