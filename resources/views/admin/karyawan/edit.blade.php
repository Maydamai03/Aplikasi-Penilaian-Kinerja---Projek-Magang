...
@section('content')
    {{-- Gunakan style yang sama dengan halaman create --}}
    <style>
        .form-card {
    ...
    <h1 style="font-size: 1.8rem;">Form Edit Data Karyawan</h1>
    ...
    <div class="form-card mt-4">
        ...
        <form action="{{ route('karyawan.update', $karyawan->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    {{-- Semua input diisi dengan data lama menggunakan old() atau data dari $karyawan --}}
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if ($karyawan->foto_profil)
                            <img src="{{ Storage::url('karyawan/' . $karyawan->foto_profil) }}" alt="Foto saat ini"
