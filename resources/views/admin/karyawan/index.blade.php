                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; align-items: center; gap: 10px;">
                                    <div style="width: 40px; height: 40px; border-radius: 50%; background: linear-gradient(135deg, #ffd700, #ff9500); display: flex; align-items: center; justify-content: center; color: #1f2937; font-weight: bold; font-size: 0.9rem;">
                            ...
                            <td>
                                <span style="background: rgba(255, 215, 0, 0.1); padding: 4px 12px; border-radius: 20px; font-weight: 600; color: #b45309;">
                            ...
                            <td class="text-center">
                                <span class="status-badge"
                                    ...
                                    <i class="fas fa-{{ $k->status_karyawan == 'Aktif' ? 'check' : ($k->status_karyawan == 'Cuti' ? 'clock' : 'times') }}"></i>
                                    {{ $k->status_karyawan }}
                                </span>
                            </td>
                            <td class="text-center">
